...
if __name__ == '__main__':
    logging.basicConfig(format=f'Discord Snapshot Bot : {util.LOGGING_FORMAT_STR_SUFFIX}',
                        level=logging.INFO, handlers=[
                            logging.handlers.RotatingFileHandler(
                                "discord_snapshot_bot.log", maxBytes=util.ONE_HUNDRED_MEGABYTES, backupCount=1),
