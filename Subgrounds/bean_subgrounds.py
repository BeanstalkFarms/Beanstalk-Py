...
pricesETH_100daysD = bean.Query.poolDayDatas(
    ...
    orderDirection="desc",
    subgraphError="deny",
    where={"pool": "0x87898263b6c5babe34b4ec53f22d98430b91e371"},
)
...
prices3CRV_100daysD = bean.Query.poolDayDatas(
    ...
    orderDirection="desc",
    subgraphError="deny",
    where={"pool": "0x3a70dfa7d2262988064a2d051dd47521e43c9bdd"},
)
...
pricesLUSD_100daysD = bean.Query.poolDayDatas(
    ...
    orderDirection="desc",
    subgraphError="deny",
    where={"pool": "0xd652c40fbb3f06d6b58cb9aa9cff063ee63d465d"},
)
